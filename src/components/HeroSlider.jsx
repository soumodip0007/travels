...
export default function HeroSlider() {
  ...
  const scrollToTours = () => {
    ...
    if (element) {
      ...
      console.warn("Tour section not found!");
    }
  };

  // Handle first button
  const handleButton1 = (button) => {
    if (button === "Enquire Now") {
      openEnquiry();
      return;
    }

    if (button === "Start Journey") {
      scrollToTours();
      return;
    }
  };
  ...
  const handleButton2 = (button) => {
    if (button === "Explore Tours") {
      scrollToTours();
      return;
    }
      ...
      <div className="hero-wave">
        ...
        >
          ...
          <path
            d="
              M321.39,56.44
              C184.06,95.11,0,23.87,0,23.87
              V120H1200V0
              S1050.68,93.28,863.91,74.63
              C706.89,58.88,570.86-12.6,321.39,56.44Z
            "
