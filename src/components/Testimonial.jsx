        ...
        >
          {testimonials.map((item) => (
            <SwiperSlide key={item.id} className="!h-auto">
              ...
              <div className="group relative min-h-[430px] flex flex-col overflow-hidden rounded-3xl border border-[#8B5CF6]/30 bg-gradient-to-br from-[#8B5CF6] to-[#6D28D9] p-8 transition-all duration-[1800ms] ease-[cubic-bezier(0.19,1,0.22,1)] hover:-translate-y-2 hover:border-[#7C3AED] hover:bg-white hover:bg-none">

                {/* Decorative circles */}

                <div className="absolute -left-12 -top-12 h-44 w-44 rounded-full bg-white/10 transition-all duration-[1800ms] ease-[cubic-bezier(0.19,1,0.22,1)] group-hover:bg-[#8B5CF6]/12 group-hover:scale-105" />

                <div className="absolute -bottom-20 -right-20 h-56 w-56 rounded-full bg-white/10 transition-all duration-[1800ms] ease-[cubic-bezier(0.19,1,0.22,1)] group-hover:bg-[#8B5CF6]/10 group-hover:scale-105" />
        ...
        <div className="mt-14 flex items-center justify-center gap-5">
          ...
          <button
            ...
            className="
              ...
              hover:to-[#9F7AEA]
              hover:text-white
              hover:shadow-[0_18px_40px_rgba(147,51,234,0.32)]
            "
          >
            <ChevronLeft size={22} />
          </button>
