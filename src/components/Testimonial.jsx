...
function ProfileImage({ src }) {
  ...
  return (
    <div className="flex h-20 w-20 shrink-0 items-center justify-center overflow-hidden rounded-full border-4 border-white/30 bg-white/20 shadow-lg transition-all duration-[1800ms] ease-[cubic-bezier(0.19,1,0.22,1)] group-hover:border-slate-200 group-hover:scale-105">
      {hasValidSource ? (
        <img
          src={src}
          alt=""
        ...
        <User
          size={38}
          strokeWidth={1.7}
          className="text-white transition-colors duration-[1800ms] ease-[cubic-bezier(0.19,1,0.22,1)] group-hover:text-slate-400"
        />
      )}
    </div>
  );
...
export default function Testimonials() {
  ...
  return (
    <section className="relative -mb-12 overflow-hidden bg-transparent py-10 backdrop-blur-xs">
        ...
        <div className="mt-14 flex items-center justify-center gap-5">
          ...
          <div
            className="
              ...
              px-4
              py-3
              shadow-[0_10px_30px_rgba(105,87,223,0.08)]
              backdrop-blur-md
            "
          >
